    ...
    <section class="hero-section set-bg" data-setbg="img/contact-bg.jpg">
        <div class="hero-text">
            <div class="container">
                ...
                <div class="page-nav">
                    <a href="./news.html" class="left-nav"><i class="lnr lnr-arrow-left"></i> Новости</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="message">
                                        <p>Текст</p>
                                        <div class="textarea">
                                            <textarea placeholder="Сообщение ..." name="sms"></textarea>
...
$qr_result = mysql_query("INSERT INTO `otziv` VALUES ('$fam','$mai','$im','$sm')" );
